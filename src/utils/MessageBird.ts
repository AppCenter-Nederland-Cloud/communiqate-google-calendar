...
export async function sendDaysMessage(conversationId: string, apiKey: string, days: any[], weekNumber: number) {
    ...
    rows.push({
        ...
        description:
            "Kies voor deze optie als u voor een andere week een afspraak wilt maken.",
    });
...
export async function sendAppointmentMessage(conversationId: string, apiKey: string, appointments: any[], date: string) {
    const rows = [];
    ...
    rows.push({
        ...
        description:
            "Kies voor deze optie als u voor een andere dag een afspraak wilt maken.",
    });
